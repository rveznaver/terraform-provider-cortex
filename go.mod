...
require (
	...
	github.com/grafana/dskit v0.0.0-20230908075806-579cf66fbf9b // indirect
	github.com/grafana/gomemcache v0.0.0-20230316202710-a081dae0aba9 // indirect
	github.com/grafana/loki v1.6.2-0.20230803180300-1221658fc5bb // indirect
...
//
// Copied from https://github.com/grafana/cortex-tools/blob/v0.11.3/go.mod
//
...
// Pin to match SDK v2.31.0; newer plugin-go (v0.25+) requires gRPC that conflicts with cortex-tools replace.
replace github.com/hashicorp/terraform-plugin-go => github.com/hashicorp/terraform-plugin-go v0.20.0
